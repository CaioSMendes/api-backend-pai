class PermissionsController < ApplicationController
  ...
  private
    ...
    def permission_params
      params.require(:permission).permit(:dtIncatu, :status,
        functionality_attributes:[:nameFunctionality, :dtIncatu, :status],
        profile_attributes:[:nameProfile, :dtIncatu, :status]
      )
    end
end